...
const Sidebar = ({ isShow, handleShowCategoryList }: IProps) => {
  ...
  return (
    <div className='scrollbar' id='style-1'>
      <ul
        className={`force-overflow duration-300 w-[280px] flex flex-col gap-6 mt-20px fixed top-0 left-0 w-280px overflow-scroll !m-0 bg-bgr shadow-3xl text-red-bold bottom-0 z-50 pl-6 pt-7 ${
