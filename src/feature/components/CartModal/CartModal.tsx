      ...
      {cartAll.length > 0 &&
        cartAll.map((item) => (
          <div>
            {/* cartItem */}
            <div
              className='px-8 py-6 rounded-lg bg-white text-black mt-5 grid grid-cols-2 min-[1024px]:gap-4 max-[1023px]:grid-cols-1 max-[1023px]:gap-8'
              key={item.id}
            >
              ...
              <div
               ...
               w-full grid grid-cols-4 max-[1366px]:flex
                max-[1366px]:justify-between max-[450px]:flex-wrap max-[450px]:gap-4
              ...
              >
                ...
                <div className='flex items-center w-[100px]  justify-center mr-[24px] border border-red-bold'>
                  <span
